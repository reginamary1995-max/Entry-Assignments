...
ORDER BY departments.department_id ASC, Employees.Salary DESC;
...
-- 2. List all departments along with the total number of employees in each department, including departments with no employees.
...
-- 3.Display all locations along with the names of employees assigned to each location. If no employees are assigned to a location,
-- display NULL for employee name.
